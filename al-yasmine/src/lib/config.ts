...
export const services = [
  {
    ...
    priceNoteAr: "يشمل الضريبة. تتوفر استشارة عاجلة بأسعار أخرى — تواصلي معنا.",
    icon:        "✦",
    timeline: [
  ...
  },
  {
    ...
    durationAr:  "٥٠ دقيقة لكل جلسة",
    price:       550,
    priceNote:   "Per session. Minimum package: 4 sessions (AED 2,200 total).",
    priceNoteAr: "لكل جلسة. الحد الأدنى للحزمة: ٤ جلسات (٢٢٠٠ درهم إجمالًا).",
    icon:        "◈",
    timeline: [
  ...
  },
  {
    ...
    durationAr:  "مدة الوصول ١٥ يومًا",
    price:       550,
    priceNote:   "Includes tax.",
    priceNoteAr: "يشمل الضريبة.",
    icon:        "◇",
    timeline: [
  ...
  },
  {
    ...
    includesAr: [
      "٦ جلسات مسجّلة أساسية",
      "دورة إضافية: أسس الاستقرار الأسري",
      "٨ جلسات إجمالًا شاملة المكافأة",
    ],
    format:      "Recorded course — links sent after payment",
  ...
  },
  {
    ...
    priceNoteAr: "تواصلي معنا للاستفسار عن السعر.",
    icon:        "✦",
    timeline: [

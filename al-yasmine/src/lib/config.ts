...
export const services = [
  ...
  },
  {
    ...
    suitableFor: [
      ...
      "Build a life of greater balance and serenity.",
      "Gain practical tools that stay with you for life.",
      "Create real, lasting change in your mental health.",
    ],
    suitableForAr: [
      "فهم نفسك بصورة أعمق.",
    ...
    suitableForHeading: "Aliya's Majlis is right for you if you want to:",
    suitableForHeadingAr: "مجلس علياء مناسب لكِ إذا كنتِ ترغبين في:",
    format:      "Online weekly sessions",
    formatAr:    "جلسات أسبوعية أونلاين",
    duration:    "4 months",
    durationAr:  "4 أشهر",
...
export const testimonials = [
  {
    id: "t1",
    name: "Doctor & mother of two — Abu Dhabi",
    nameAr: "طبيبة وأم لطفلين - أبوظبي",
    quote: "Honestly, I used to say it was impossible for me to change. Today I can say I'm more at ease than ever before, and I feel closer to myself and to my children than I have in a long time.",
  ...
  },
  {
    ...
    name: "Writer — Muscat",
    nameAr: "كاتبة - مسقط",
    quote: "I wasn't expecting to benefit this much. I feel I understand myself more, and I deal with my feelings with calm and awareness. Even my outlook on life has changed in a beautiful way.",
  ...
  {
    id: "t3",
    name: "Businesswoman — Dubai",
    nameAr: "سيدة أعمال - دبي",
    quote: "The biggest difference for me is that I now live with greater peace of mind. The things that used to drain me emotionally no longer affect me the way they used to.",
  ...
  {
    id: "t4",
    name: "Mother of three — Riyadh",
    nameAr: "أم لثلاثة أبناء - الرياض",
    quote: "I used to feel lost and scattered, not knowing where to start. Today I have more clarity, and I know how to deal with myself and with what I'm going through.",
  ...
  },
  {
    ...
    name: "Teacher — Kuwait",
    nameAr: "معلمة - الكويت",
    quote: "What changed wasn't my circumstances — what changed is that I changed. I've become calmer and kinder with myself, and I enjoy the details of my life more.",

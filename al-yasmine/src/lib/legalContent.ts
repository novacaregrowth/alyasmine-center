    ...
    policies: [
      {
        ...
        intro: [
          {
            p: "يولي مركز الياسمين للتدريب والاستشارات والإرشاد النفسي أهمية كبيرة لخصوصية العملاء والمستخدمين، ويلتزم بحماية البيانات الشخصية وفق القوانين المعمول بها في دولة الإمارات العربية المتحدة، بما في ذلك قانون حماية البيانات الشخصية الإماراتي.",
          },
          {
        ...
        sections: [
          ...
          },
          {
            ...
            blocks: [
              { p: "في بعض خدمات الإرشاد والتدريب النفسي أو الاستشارة والإرشاد، قد يشارك العميل معلومات شخصية أو نفسية أو أسرية أو صحية حساسة." },

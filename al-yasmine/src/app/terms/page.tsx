  ...
  return (
    <div className="pt-20 pb-28">
      <div className="section-container max-w-2xl mx-auto pt-16">
        ...
        <h1 className="font-display font-light text-brand-charcoal mb-4">Terms & Conditions</h1>
        <div className="w-14 h-0.5 bg-brand-gold mb-10" />

        <div className="space-y-8 text-brand-charcoal/70 text-sm leading-relaxed">

          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">1. Services</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">2. Bookings & Cancellations</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">3. Payments</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">4. Refund Policy</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">5. Intellectual Property</h2>

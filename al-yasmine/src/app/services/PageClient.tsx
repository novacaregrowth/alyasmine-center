      ...
      <section className="relative pb-8" style={{ background: "linear-gradient(160deg,#f6f2e9 0%,#eef6f6 100%)" }}>
        <div className="section-container max-w-3xl pt-16 pb-12">
          <Reveal>
            ...
            <h1 className="font-display font-light text-brand-charcoal mb-4">Our Services</h1>
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-brand-charcoal/35 mt-0.5">per {s.duration}</p>
                  </div>
                </div>
                <div>
                  <h2 className="font-display text-2xl text-brand-charcoal mb-1">{s.title}</h2>
                  {s.titleAr && <p className="arabic text-brand-teal-light text-sm mb-3" lang="ar">{s.titleAr}</p>}
                  <p className="text-brand-charcoal/55 leading-relaxed text-sm">{s.description}</p>
                </div>
      ...
      <section className="bg-brand-cream pt-6 pb-20">
        <div className="section-container max-w-2xl mx-auto py-14">
          <Reveal className="text-center mb-12">
            <h2 className="font-display font-light text-brand-charcoal mb-2">Frequently Asked</h2>
          ...
          <StaggerReveal className="space-y-4">
            {[
              ...
              >
                <h4 className="font-medium text-brand-charcoal mb-2 text-sm">{faq.q}</h4>
                <p className="text-xs text-brand-charcoal/55 leading-relaxed">{faq.a}</p>
              </motion.div>
            ))}
          </StaggerReveal>
        </div>

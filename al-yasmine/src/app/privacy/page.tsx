  ...
  return (
    <div className="pt-20 pb-28">
      <div className="section-container max-w-2xl mx-auto pt-16">
        ...
        <h1 className="font-display font-light text-brand-charcoal mb-4">Privacy Policy</h1>
        <div className="w-14 h-0.5 bg-brand-gold mb-10" />

        <div className="prose prose-sm max-w-none space-y-8 text-brand-charcoal/70 text-sm leading-relaxed">

          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">3. Confidentiality</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">4. Data Storage & Security</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">5. Your Rights</h2>
          ...
          <section>
            <h2 className="font-display text-xl text-brand-charcoal mb-3 font-light">6. Contact</h2>
          ...
          <p className="text-xs text-brand-charcoal/40 pt-4 border-t border-brand-cream">Last updated: January 2026. Al Yasmine Center, UAE.</p>
        </div>
